...
<<<<<<< HEAD:MedicinePage.xaml.cs
            ...
            MedicineDescriptionTextBox.Text = vm.Use;
            MedicinePriceTextBox.Text = vm.PricePerBox.ToString();
            MedicineTypeComboBox.Text = vm.MedicineType;

            // Store the barcode for editing
...
<<<<<<< HEAD:MedicinePage.xaml.cs
            ...
            {
                MessageBox.Show("Error occurred during delete:\n" + ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
